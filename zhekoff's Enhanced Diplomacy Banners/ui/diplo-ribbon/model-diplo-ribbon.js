...
(function (RibbonYieldType) {
    ...
    RibbonYieldType["Envoys"] = "envoys";
    RibbonYieldType["Settlements"] = "settlements";
    RibbonYieldType["Property"] = "property";
    RibbonYieldType["Victory"] = "victory";
    RibbonYieldType["Total Gold"] = "totalGold";
    RibbonYieldType["Total Diplomacy"] = "totalDiplomacy";
    RibbonYieldType["Total Population"] = "totalPopulation";
...
class DiploRibbonModel {
    constructor() {
        ...
        this.alwaysShowYields = RibbonStatsToggleStatus.RibbonStatsShowing;
    ...
    createPlayerData(player, playerDiplomacy, isKnownPlayer, relationshipData) {
        ...
        const dataObj = {
            ...
            portrait: isKnownPlayer ? (Icon.getLeaderPortraitIcon(player.leaderType, undefined, relationshipData?.relationshipType)) : "fs://game/base-standard/leader_portrait_unknown.png",
    ...
    createPlayerYieldsData(playerLibrary, isLocal) {
        ...
        // Total Gold / Diplomacy values
        const totalGold = Math.round(playerLibrary.Treasury.goldBalance);
        const totalDiplomacy = Math.round(playerLibrary.DiplomacyTreasury.diplomacyBalance);
