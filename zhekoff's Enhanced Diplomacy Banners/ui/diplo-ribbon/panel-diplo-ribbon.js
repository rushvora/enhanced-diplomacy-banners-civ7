...
export class PanelDiploRibbon extends Panel {
    ...
    populateFlags() {
        ...
        for (let cardIndex = 0; cardIndex < targetArray.length; cardIndex++) {
            ...
            civFlagContainer.classList.add("show-on-hover");
            ...
            diploMainBG.classList.value = 'diplo-background absolute inset-0';
            diploMainBG.classList.toggle("player-at-war", player.isAtWar);
            ...
            portrait.classList.value = "diplo-ribbon__portrait-image absolute inset-0 bg-contain bg-no-repeat bg-top mb-0\\.5";
            portrait.style.backgroundImage = `url('${player.portrait}')`;
