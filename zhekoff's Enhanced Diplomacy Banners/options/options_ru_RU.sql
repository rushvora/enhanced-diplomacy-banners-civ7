----------------------------------
-- Russian Localization for Enhanced Diplomacy Banners Settings (Credit to Webrok)
----------------------------------
...
VALUES
    ...
    "ru_RU",
    "Улучшенные Дипломатические Баннеры"),
    
    -- Icon Style Option
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_NAME",
    "ru_RU",
    "Стиль Иконок Отношений"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_DESCRIPTION",
    "ru_RU",
    "Выберите визуальный стиль для иконок отношений, отображаемых на дипломатической ленте."),
    ...
    "ru_RU",
    "Показывать Символ Цивилизации"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_CIV_SYMBOL_DESCRIPTION",
    "ru_RU",
    "Отображать символы цивилизаций на дипломатических баннерах."),
    ...
    "ru_RU",
    "Всегда Показывать Дополнительные Доходы"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ALWAYS_SHOW_EXTENDED_YIELDS_DESCRIPTION",
    "ru_RU",
    "Всегда отображать дополнительные доходы без необходимости наведения курсора."),
    ...
    "ru_RU",
    "Выберите стиль фона для дипломатических баннеров."),
