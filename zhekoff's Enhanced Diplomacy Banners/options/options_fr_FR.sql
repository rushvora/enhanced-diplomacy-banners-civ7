----------------------------------
-- French Localization for Enhanced Diplomacy Banners Settings
----------------------------------
...
VALUES
    ...
    "fr_FR",
    "Bannières Diplomatiques Améliorées"),
    
    -- Icon Style Option
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_NAME",
    "fr_FR",
    "Style d'Icônes de Relation"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_DESCRIPTION",
    "fr_FR",
    "Choisissez le style visuel des icônes de relation affichées sur le ruban diplomatique."),
    ...
    "fr_FR",
    "Afficher les Symboles de Civilisation"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_CIV_SYMBOL_DESCRIPTION",
    "fr_FR",
    "Afficher les symboles de civilisation sur les bannières diplomatiques."),
    ...
    "fr_FR",
    "Toujours Afficher les Rendements Supplémentaires"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ALWAYS_SHOW_EXTENDED_YIELDS_DESCRIPTION",
    "fr_FR",
    "Toujours afficher les rendements supplémentaires sans passer la souris dessus."),
    ...
    "fr_FR",
    "Style d'Arrière-plan des Bannières"),

    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_BACKGROUND_STYLE_DESCRIPTION",
    "fr_FR",
    "Choisissez le style d'arrière-plan pour les bannières diplomatiques."),
    ...
    "fr_FR",
    "Masquer les Bannières Diplomatiques"),

    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_HIDE_BANNERS_DESCRIPTION",
    "fr_FR",
    "Masque les bannières diplomatiques - elles n'apparaîtront qu'au survol de la souris."),

    -- Checkbox for disabling leader expressions
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_DISABLE_LEADER_EXPRESSIONS_NAME",
    "fr_FR",
    "Désactiver les Expressions des Dirigeants"),
