----------------------------------
-- Polish Localization for Enhanced Diplomacy Banners Settings
----------------------------------
...
VALUES
    ...
    "pl_PL",
    "Ulepszone Bannery Dyplomatyczne"),
    ...
    "pl_PL",
    "Wybierz styl wizualny ikon relacji wyświetlanych na wstążce dyplomatycznej."),
    ...
    "pl_PL",
    "Pokaż Symbol Cywilizacji"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_CIV_SYMBOL_DESCRIPTION",
    "pl_PL",
    "Wyświetla symbole cywilizacji na bannerach dyplomatycznych."),
    ...
    "pl_PL",
    "Zawsze Pokazuj Dodatkowe Plony"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ALWAYS_SHOW_EXTENDED_YIELDS_DESCRIPTION",
    "pl_PL",
    "Zawsze wyświetlaj dodatkowe plony bez konieczności najechania kursorem."),
