----------------------------------
-- English US Localization for Enhanced Diplomacy Banners Settings
----------------------------------
...
VALUES
    ...
    "en_US",
    "Relationship Icon Style"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_DESCRIPTION",
    "en_US",
    "Choose the visual style for relationship icons shown on the diplomacy ribbon."),
    ...
    "en_US",
    "Show Civilization Symbol"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_CIV_SYMBOL_DESCRIPTION",
    "en_US",
    "Display civilization symbols on diplomacy banners."),
    ...
    "en_US",
    "Always Show Additional Yields"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ALWAYS_SHOW_EXTENDED_YIELDS_DESCRIPTION",
    "en_US",
    "Always display additional yields without requiring hover."),
    ...
    "en_US",
    "Choose the background style for diplomacy banners."),
    ...
    "en_US",
    "Adjust the size of diplomat banners for a more compact display."),
    ...
    "en_US",
    "Show All Yields on Local Player Hover"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_ALL_YIELDS_ON_LOCAL_HOVER_DESCRIPTION",
    "en_US",
    "When hovering over your own leader portrait, show the detailed yields for all other leaders as well.");
