----------------------------------
-- Spanish Localization for Enhanced Diplomacy Banners Settings
----------------------------------
...
VALUES
    ...
    "es_ES",
    "Banners de Diplomacia Mejorados"),
    
    -- Icon Style Option
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_NAME",
    "es_ES",
    "Estilo de Iconos de Relación"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_DESCRIPTION",
    "es_ES",
    "Elige el estilo visual para los iconos de relación mostrados en la cinta diplomática."),
    ...
    "es_ES",
    "Mostrar Símbolo de Civilización"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_CIV_SYMBOL_DESCRIPTION",
    "es_ES",
    "Mostrar símbolos de civilización en los banners diplomáticos."),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_CIV_SYMBOL_YES",
    "es_ES",
    "Sí"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_CIV_SYMBOL_NO",
    "es_ES",
    "No"),

    -- Always Show Extended Yields Option
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ALWAYS_SHOW_EXTENDED_YIELDS_NAME",
    "es_ES",
    "Mostrar Siempre Rendimientos Adicionales"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ALWAYS_SHOW_EXTENDED_YIELDS_DESCRIPTION",
    "es_ES",
    "Mostrar siempre rendimientos adicionales sin necesidad de pasar el cursor."),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ALWAYS_SHOW_EXTENDED_YIELDS_YES",
    "es_ES",
    "Sí"),
    ...
    "es_ES",
    "Estilo de Fondo del Banner"),

    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_BACKGROUND_STYLE_DESCRIPTION",
    "es_ES",
    "Elige el estilo de fondo para los banners diplomáticos."),
    ...
    "es_ES",
    "Ajusta el tamaño de los banners diplomáticos para una visualización más compacta."),
    ...
    "es_ES",
    "Mostrar Todos los Rendimientos al Pasar sobre el Jugador Local"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_ALL_YIELDS_ON_LOCAL_HOVER_DESCRIPTION",
    "es_ES",
    "Al pasar el cursor sobre tu propio retrato de líder, también se muestran los rendimientos detallados de todos los demás líderes.");
