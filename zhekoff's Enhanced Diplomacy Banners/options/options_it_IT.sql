----------------------------------
-- Italian Localization for Enhanced Diplomacy Banners Settings
----------------------------------
...
VALUES
    ...
    "it_IT",
    "Banner Diplomatici Migliorati"),
    
    -- Icon Style Option
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_NAME",
    "it_IT",
    "Stile Icone Relazioni"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_DESCRIPTION",
    "it_IT",
    "Scegli lo stile visivo per le icone delle relazioni mostrate nel nastro diplomatico."),
    ...
    "it_IT",
    "Mostra Simbolo Civiltà"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_CIV_SYMBOL_DESCRIPTION",
    "it_IT",
    "Mostra i simboli delle civiltà sui banner diplomatici."),
    ...
    "it_IT",
    "Mostra Sempre Rendimenti Aggiuntivi"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ALWAYS_SHOW_EXTENDED_YIELDS_DESCRIPTION",
    "it_IT",
    "Mostra sempre i rendimenti aggiuntivi senza dover passare sopra con il mouse."),
    ...
    "it_IT",
    "Scegli lo stile dello sfondo per i banner diplomatici."),
