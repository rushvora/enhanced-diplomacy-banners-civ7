----------------------------------
-- German Localization for Enhanced Diplomacy Banners Settings
----------------------------------
...
VALUES
    ...
    "de_DE",
    "Verbesserte Diplomatie-Banner"),
    
    -- Icon Style Option
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_NAME",
    "de_DE",
    "Beziehungssymbol-Stil"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ICON_STYLE_DESCRIPTION",
    "de_DE",
    "Wählen Sie den visuellen Stil für Beziehungssymbole im Diplomatie-Banner."),
    ...
    "de_DE",
    "Zivilisationssymbole anzeigen"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_SHOW_CIV_SYMBOL_DESCRIPTION",
    "de_DE",
    "Zivilisationssymbole auf Diplomatie-Bannern anzeigen."),
    ...
    "de_DE",
    "Zusätzliche Erträge immer anzeigen"),
    
    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_ALWAYS_SHOW_EXTENDED_YIELDS_DESCRIPTION",
    "de_DE",
    "Zusätzliche Erträge immer anzeigen, ohne dass Hover erforderlich ist."),
    ...
    "de_DE",
    "Banner-Hintergrundstil"),

    ("LOC_MOD_ZHEKOFF_DIPLO_RIBBON_BACKGROUND_STYLE_DESCRIPTION",
    "de_DE",
    "Wählen Sie den Hintergrundstil für Diplomatie-Banner."),
